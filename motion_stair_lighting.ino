...
void loop() {
  ...
  Serial.println((String)"SEGMENTS_UP element 0 = " + SEGMENTS_UP[0]);
  Serial.println((String)"SEGMENTS_UP element 1 = " + SEGMENTS_UP[1]);
  Serial.println((String)"SEGMENTS_UP element 2 = " + SEGMENTS_UP[2]);
  Serial.println((String)"SEGMENTS_UP element 10 = " + SEGMENTS_UP[10]);
  Serial.println((String)"SEGMENTS_UP element 15 = " + SEGMENTS_UP[15]);
  ...
  Serial.println((String)"SEGMENTS_DOWN element 10 = " + SEGMENTS_DOWN[10]);
  Serial.println((String)"SEGMENTS_DOWN element 15 = " + SEGMENTS_DOWN[15]);
